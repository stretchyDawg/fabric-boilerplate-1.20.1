package net.stretchydawg.demomod.block;
...
import net.stretchydawg.demomod.block.custom.SoundBlock;
import net.stretchydawg.demomod.block.custom.TomatoCropBlock;

public class ModBlocks {
    public static final Block RUBY_BLOCK = registerBlock("ruby_block",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
    public static final Block RAW_RUBY_BLOCK = registerBlock("raw_ruby_block",
            new Block(FabricBlockSettings.copyOf(Blocks.RAW_IRON_BLOCK).sounds(BlockSoundGroup.ANCIENT_DEBRIS)));
    ...
    public static final Block TOMATO_CROP = Registry.register(Registries.BLOCK, new Identifier(DemoMod.MOD_ID, "tomato_crop"),
